...
const { connectDB } = require('./seperate/backend_communication/config/database');
const User = require('./seperate/backend_communication/models/User');
const Message = require('../models/Message');
const Poll = require('./seperate/backend_communication/models/Poll');
